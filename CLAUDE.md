...
- The file client-configuration-for-environment.md in the BikS2013/ClaudeGuide repository describes how to implement the "client app configuration pattern" to support environment specific partameters.
